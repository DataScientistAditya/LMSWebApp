...
// import HeaderSearchComp from "./SearchComp/SearchComp";
...
const LogoImage = require("../../static/images/logo-3.png")
const LandingHeaderComp=(props)=>{
    ...
    return(
        <section>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ed-com-t1-left">
                                <ul>
                                    <li><a style={{color:"white"}} >Contact: Lake Road, Kolkata, India.</a>
                                    </li>
                                    <li><a style={{color:"white"}}>Phone: +101-1231-1231</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="ed-com-t1-right">
                                <ul>
                                    {(IsLoggedIn)?<li><a style={{textDecoration:"none",color:"white"}} onClick={SignOutHandler}   data-toggle="modal" data-target="#modal1">Sign Out</a>
                                    </li>:<li><a style={{textDecoration:"none",color:"white"}} onClick={()=>{props.onSignin(true)}}   data-toggle="modal" data-target="#modal1">Sign In</a>
                                    </li>}
            ...
            <div class="top-logo" data-spy="affix" data-offset-top="250">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wed-logo">
                                <a ><img src={LogoImage} alt="" />
                                </a>
                            </div>
                            <div class="main-menu">
                                <ul>
                                    <li><a onClick={()=>{nav("/")}}>Home</a>
                                    </li>
                                    ...
                                    {(IsLoggedIn)?<li><a onClick={()=>{nav("/dashboard")}}>My Dashboard</a>
                                    </li>:<li><a>Contact us</a>
                                    </li>}
            ...
            {/* <HeaderSearchComp></HeaderSearchComp> */}
        </section>
    )
}
