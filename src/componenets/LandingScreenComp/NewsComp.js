                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="ho-event ho-event-mob-bot-sp">
                            <ul>
                                <li>
                                    <div class="ho-ev-img"><img src={require("../../static/images/event/1.jpg")} alt="" />
                                    </div>
                                    <div class="ho-ev-link">
                                        <a href="#">
                                ...
                                <li>
                                    <div class="ho-ev-img"><img src={require("../../static/images/event/2.jpg")}alt="" />
                                    </div>
                                    <div class="ho-ev-link">
                                        <a>
                                ...
                                <li>
                                    <div class="ho-ev-img"><img src={require("../../static/images/event/3.jpg")} alt="" />
                                    </div>
                                    <div class="ho-ev-link">
                                        <a href="#">
                                ...
                                <li>
                                    <div class="ho-ev-img"><img src={require("../../static/images/event/4.jpg")} alt="" /></div>
                                    <div class="ho-ev-link">
                                        <a href="#">
                                            <h4>Then came the night of the first falling star.</h4>
                                        </a>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="ho-st-login">
                            <ul class="tabs tabs-hom-reg">
                                {/* <li class="tab col s6"><a >Register</a>
                                </li> */}
                                <li class="tab col s6"><a >Login</a>
                                </li>
                            </ul>
                            ...
                            <div id="hom_log" class="col s12">
                                <form class="col s12">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input style={{color:"black"}} type="submit" value="Login" class="waves-effect waves-light light-btn" />
                                        </div>
                                    </div>
                                </form>
                            </div>
...
export default UpcomingNewsComp;