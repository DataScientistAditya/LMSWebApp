...
import CourseDetailsMainComp from "../../componenets/DetailsScreenComp/CourseDetailsMainComp";
...
const CourseModuleDetailsScreen=()=>{
    ...
    if (IsLoggedIn) {
        return(
            <div>
                ...
                <CourseDetailsMainComp></CourseDetailsMainComp>
...
export default CourseModuleDetailsScreen;